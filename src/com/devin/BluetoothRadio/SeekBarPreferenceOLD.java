...
public class SeekBarPreferenceOLD extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    public SeekBarPreferenceOLD(Context context) {
        super(context);
    }

    public SeekBarPreferenceOLD(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SeekBarPreferenceOLD(Context context, AttributeSet attrs, int defStyle) {
